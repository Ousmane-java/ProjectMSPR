"""
Django settings for seahawks_nester project.
...
SECRET_KEY = 'django-insecure-3d-qsa+bt$r3)i7tb9*qlo40bt5*my=jep35b%_6tfg(7_8**b'
...
ROOT_URLCONF = 'seahawks_nester.urls'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'sondes/static'),
]
